...
CLINVAR_FILE  = r"clinvar_variant.txt"
GNOMAD_FILE   = r"gnomAD_B_all.csv"
GROUPC_FILE   = r"EDAR_Gruppe_C.csv"

OUT_A         = r"EDAR_GroupA.csv"
OUT_B         = r"EDAR_GroupB.csv"
OUT_VARIANTSET    = r"EDAR_Variant_Set.csv"
